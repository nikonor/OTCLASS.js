...
__И ни в коем случае тут нельзя использовать вызов update, потому как тогда в dates останется только bdate__
...
Но это упрошенный вариант. На самом деле этот параметр может быть массовим таких словарей. Пока, правда, реализованно только условие точное сравнение eq, чуть позже будут реализованы условия остальных типов
